...
CALIB = 'TMAX2Be' # the name of the calibration
...
DETECTORS_INFO={'theta_center':[52.125,20,24.9,52.975], 'phi_center': [0,0,180,180], 'distance_center':[0.1779,0.3459,0.3319,0.1853], 'num_strips':16, 'detector_width':0.05 , }    
