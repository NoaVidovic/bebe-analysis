...
CALIB = 'AVG' # the name of the calibration
...
DETECTORS_INFO={'theta_center':[52.125,20,24.9,52.975], 'phi_center': [0,0,180,180], 'distance_center':[0.15675,0.3179,0.3048,0.1604], 'num_strips':16, 'detector_width':0.05 , }    
